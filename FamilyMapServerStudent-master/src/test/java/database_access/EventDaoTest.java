...
public class EventDaoTest {
    ...
    public void setUp() throws DatabaseException{
        ...
        testEvent = new Event("eventID", "descendant", "personID", 0.0, 0.0, "country", "city", "eventType", 0);
    ...
    public void removeUserData() throws DatabaseException {
        ...
        Event testEvent2 = new Event ("eventID2", "descendant2", "personID2", 0., 0., "country2", "city2", "eventType2", 0);


        eDao.insert(testEvent);
        eDao.insert(testEvent2);

        eDao.removeUserData(testEvent.getDescendant());
